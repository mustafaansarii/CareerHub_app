  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Angular", prompt: "Explain Angular framework architecture and core concepts" },
        { id: 2, title: "Components Basics", prompt: "Guide to creating and using Angular components" },
        { id: 3, title: "Templates & Data Binding", prompt: "Understanding Angular template syntax and data binding" },
        { id: 4, title: "Dependency Injection", prompt: "Understanding Angular's dependency injection system" },
      ]
    },
    {
      category: "Components & Templates",
      items: [
        { id: 5, title: "Component Communication", prompt: "Parent-child and sibling component communication techniques" },
        { id: 6, title: "Directives", prompt: "Creating and using Angular directives" },
        { id: 7, title: "Pipes", prompt: "Creating custom pipes and using built-in pipes" },
        { id: 8, title: "Content Projection", prompt: "Using ng-content for component composition" },
      ]
    },
    {
      category: "RxJS & Observables",
      items: [
        { id: 9, title: "Observables Basics", prompt: "Working with Observables and RxJS operators" },
        { id: 10, title: "Subjects", prompt: "Using Subjects for cross-component communication" },
        { id: 11, title: "HTTP Client", prompt: "Making API calls with Angular HttpClient" },
        { id: 12, title: "State Management", prompt: "Managing application state with RxJS" },
      ]
    },
    {
      category: "Forms & Validation",
      items: [
        { id: 13, title: "Template-driven Forms", prompt: "Creating and validating template-driven forms" },
        { id: 14, title: "Reactive Forms", prompt: "Building complex reactive forms with validation" },
        { id: 15, title: "Custom Validators", prompt: "Creating custom form validators" },
        { id: 16, title: "Dynamic Forms", prompt: "Building dynamic forms programmatically" },
      ]
    },
    {
      category: "Routing & Navigation",
      items: [
        { id: 17, title: "Router Basics", prompt: "Setting up Angular router with navigation" },
        { id: 18, title: "Lazy Loading", prompt: "Implementing lazy-loaded feature modules" },
        { id: 19, title: "Route Guards", prompt: "Creating authentication and authorization guards" },
        { id: 20, title: "Nested Routes", prompt: "Implementing nested router outlets" },
      ]
    },
    {
      category: "Performance Optimization",
      items: [
        { id: 21, title: "Change Detection", prompt: "Optimizing change detection strategies" },
        { id: 22, title: "Lazy Loading", prompt: "Optimizing bundle size with lazy loading" },
        { id: 23, title: "Performance Monitoring", prompt: "Using Angular DevTools for performance analysis" },
        { id: 24, title: "AOT Compilation", prompt: "Benefits of Ahead-of-Time compilation" },
      ]
    },
    {
      category: "Testing",
      items: [
        { id: 25, title: "Component Testing", prompt: "Writing unit tests with TestBed" },
        { id: 26, title: "E2E Testing", prompt: "Implementing end-to-end tests with Cypress" },
        { id: 27, title: "Mock Services", prompt: "Mocking dependencies in Angular tests" },
        { id: 28, title: "Test Coverage", prompt: "Measuring and improving test coverage" },
      ]
    },
    {
      category: "Advanced Features",
      items: [
        { id: 29, title: "Dynamic Components", prompt: "Creating and rendering components dynamically" },
        { id: 30, title: "Angular Elements", prompt: "Creating web components with Angular Elements" },
        { id: 31, title: "Internationalization", prompt: "Implementing i18n in Angular applications" },
        { id: 32, title: "Server-side Rendering", prompt: "Implementing SSR with Angular Universal" },
      ]
    },
    {
      category: "Deployment & CI/CD",
      items: [
        { id: 33, title: "Production Builds", prompt: "Optimizing Angular production builds" },
        { id: 34, title: "Docker Deployment", prompt: "Containerizing Angular applications" },
        { id: 35, title: "CI/CD Pipelines", prompt: "Setting up automated deployment pipelines" },
        { id: 36, title: "Performance Budgets", prompt: "Implementing performance budgets" },
      ]
    },
    {
      category: "State Management",
      items: [
        { id: 37, title: "NgRx Store", prompt: "Implementing state management with NgRx" },
        { id: 38, title: "NgRx Effects", prompt: "Managing side effects with NgRx" },
        { id: 39, title: "Alternative Stores", prompt: "Using alternative state management libraries" },
        { id: 40, title: "Service-based State", prompt: "Implementing state management with services" },
      ]
    }
  ];
                ...
                <nav className="flex" aria-label="Breadcrumb">
                  <ol className="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li className="inline-flex items-center">
                      ...
                      <span className="text-indigo-600">Angular Tutorials</span>
                    </li>
                  </ol>
                </nav>
...
export default AngularTutorials;  