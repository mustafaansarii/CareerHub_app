  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Vue", prompt: "Explain Vue framework and its core concepts" },
        { id: 2, title: "Components Basics", prompt: "Creating and using Vue components" },
        { id: 3, title: "Template Syntax", prompt: "Understanding Vue's template syntax and directives" },
        { id: 4, title: "Reactivity System", prompt: "Understanding Vue's reactivity system" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 6, title: "Slots", prompt: "Using slots for component composition" },
        { id: 7, title: "Dynamic Components", prompt: "Creating and using dynamic components" },
        { id: 8, title: "Mixins", prompt: "Using mixins for code reuse" },
      ]
    },
    {
      category: "State Management",
      items: [
        { id: 9, title: "Vuex Basics", prompt: "Implementing state management with Vuex" },
        { id: 10, title: "Pinia", prompt: "Using Pinia for state management" },
        { id: 11, title: "Reactive State", prompt: "Managing reactive state with Composition API" },
        { id: 12, title: "Global State", prompt: "Implementing global state management patterns" },
      ]
    },
    {
      category: "Routing & Navigation",
      items: [
        { id: 13, title: "Vue Router Basics", prompt: "Setting up routing with Vue Router" },
        { id: 14, title: "Nested Routes", prompt: "Implementing nested routes in Vue" },
        { id: 15, title: "Route Guards", prompt: "Creating authentication and authorization guards" },
    ...
    },
    {
      ...
      items: [
        { id: 17, title: "Form Handling", prompt: "Creating and validating forms in Vue" },
        { id: 18, title: "Custom Validators", prompt: "Creating custom form validators" },
        { id: 19, title: "VeeValidate", prompt: "Using VeeValidate for form validation" },
        { id: 20, title: "Form Libraries", prompt: "Using popular Vue form libraries" },
      ]
    },
    {
      category: "Performance Optimization",
      items: [
        { id: 21, title: "Reactivity Optimization", prompt: "Optimizing Vue's reactivity system" },
        { id: 22, title: "Code Splitting", prompt: "Implementing code splitting in Vue" },
        { id: 23, title: "Performance Monitoring", prompt: "Using Vue DevTools for performance analysis" },
        { id: 24, title: "Lazy Loading Components", prompt: "Optimizing bundle size with lazy loading" },
      ]
    },
    {
      category: "Testing",
      items: [
        { id: 25, title: "Component Testing", prompt: "Writing unit tests with Vue Test Utils" },
        { id: 26, title: "E2E Testing", prompt: "Implementing end-to-end tests with Cypress" },
        { id: 27, title: "Mocking Dependencies", prompt: "Mocking dependencies in Vue tests" },
    ...
    },
    {
      ...
      items: [
        { id: 29, title: "Composition API", prompt: "Using Vue's Composition API" },
        { id: 30, title: "Custom Directives", prompt: "Creating and using custom directives" },
        { id: 31, title: "Plugins", prompt: "Creating and using Vue plugins" },
        { id: 32, title: "Server-side Rendering", prompt: "Implementing SSR with Nuxt.js" },
      ]
    },
    {
      category: "Deployment & CI/CD",
      items: [
        { id: 33, title: "Production Builds", prompt: "Optimizing Vue production builds" },
        { id: 34, title: "Docker Deployment", prompt: "Containerizing Vue applications" },
    ...
    },
    {
      category: "Ecosystem",
      items: [
        { id: 37, title: "Nuxt.js", prompt: "Building applications with Nuxt.js" },
        { id: 38, title: "Vite", prompt: "Using Vite with Vue" },
        { id: 39, title: "UI Libraries", prompt: "Using popular Vue UI libraries" },
        { id: 40, title: "TypeScript", prompt: "Using TypeScript with Vue" },
      ]
    }
  ];
