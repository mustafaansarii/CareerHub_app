  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Svelte", prompt: "Explain Svelte framework and its core concepts" },
        { id: 2, title: "Components Basics", prompt: "Creating and using Svelte components" },
        { id: 3, title: "Reactive Declarations", prompt: "Understanding Svelte's reactive statements" },
        { id: 4, title: "Props & Context", prompt: "Passing data between components with props and context" },
      ]
    },
    {
      category: "State Management",
      items: [
        { id: 5, title: "Stores Basics", prompt: "Using Svelte stores for state management" },
        { id: 6, title: "Writable Stores", prompt: "Creating and using writable stores" },
        { id: 7, title: "Derived Stores", prompt: "Creating computed values with derived stores" },
        { id: 8, title: "Custom Stores", prompt: "Implementing custom store patterns" },
      ]
    },
    {
      category: "Templates & Directives",
      items: [
        { id: 9, title: "Conditional Rendering", prompt: "Using if blocks and conditional rendering" },
        { id: 10, title: "Loops", prompt: "Iterating with each blocks" },
        { id: 11, title: "Bindings", prompt: "Using two-way data binding in Svelte" },
        { id: 12, title: "Actions", prompt: "Creating and using element actions" },
      ]
    },
    {
      category: "Animations & Transitions",
      items: [
        { id: 13, title: "Basic Transitions", prompt: "Using Svelte's built-in transitions" },
        { id: 14, title: "Custom Transitions", prompt: "Creating custom transition functions" },
        { id: 15, title: "Animations", prompt: "Implementing animations with Svelte" },
        { id: 16, title: "Motion", prompt: "Using the motion store for animations" },
      ]
    },
    {
      category: "Advanced Features",
      items: [
        { id: 17, title: "Slots", prompt: "Using slots for component composition" },
        { id: 18, title: "Context API", prompt: "Sharing data with Svelte's context API" },
        { id: 19, title: "Lifecycle Functions", prompt: "Using Svelte's lifecycle functions" },
        { id: 20, title: "Custom Elements", prompt: "Creating web components with Svelte" },
      ]
    },
    {
      category: "Performance Optimization",
      items: [
        { id: 21, title: "Compile-time Optimization", prompt: "Understanding Svelte's compile-time optimizations" },
        { id: 22, title: "Lazy Loading", prompt: "Implementing code-splitting in Svelte" },
        { id: 23, title: "Bundle Analysis", prompt: "Analyzing and optimizing Svelte bundles" },
        { id: 24, title: "Memory Management", prompt: "Optimizing memory usage in Svelte apps" },
      ]
    },
    {
      category: "Testing",
      items: [
        { id: 25, title: "Unit Testing", prompt: "Writing unit tests for Svelte components" },
        { id: 26, title: "E2E Testing", prompt: "Implementing end-to-end tests with Cypress" },
        { id: 27, title: "Testing Stores", prompt: "Testing Svelte stores and state management" },
    ...
    },
    {
      ...
      items: [
        { id: 29, title: "Production Builds", prompt: "Optimizing Svelte production builds" },
        { id: 30, title: "Docker Deployment", prompt: "Containerizing Svelte applications" },
        { id: 31, title: "CI/CD Pipelines", prompt: "Setting up automated deployment pipelines" },
        { id: 32, title: "Performance Budgets", prompt: "Implementing performance budgets" },
      ]
    },
    {
      category: "Ecosystem Integration",
      items: [
        { id: 33, title: "SvelteKit Basics", prompt: "Getting started with SvelteKit" },
        { id: 34, title: "Routing", prompt: "Implementing routing in SvelteKit" },
        { id: 35, title: "API Integration", prompt: "Integrating with REST and GraphQL APIs" },
        { id: 36, title: "Authentication", prompt: "Implementing authentication in Svelte apps" },
      ]
    }
  ];
...
export default SvelteTutorials;  