  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Next.js", prompt: "Explain Next.js framework and its advantages for React development" },
        { id: 2, title: "Project Setup", prompt: "Guide to creating a Next.js project using create-next-app" },
        { id: 3, title: "File-based Routing", prompt: "Understanding Next.js file-based routing system" },
        { id: 4, title: "Pages & Layouts", prompt: "Creating pages and layouts in Next.js" },
      ]
    },
    {
      category: "Rendering Strategies",
      items: [
        { id: 5, title: "Static Site Generation", prompt: "Implementing Static Site Generation (SSG) in Next.js" },
        { id: 6, title: "Server-side Rendering", prompt: "Using Server-side Rendering (SSR) in Next.js" },
        { id: 7, title: "Incremental Static Regeneration", prompt: "Implementing ISR for dynamic static sites" },
        { id: 8, title: "Client-side Rendering", prompt: "Using Client-side Rendering (CSR) in Next.js" },
      ]
    },
    {
      category: "Data Fetching",
      items: [
        { id: 9, title: "getStaticProps", prompt: "Using getStaticProps for static generation" },
        { id: 10, title: "getServerSideProps", prompt: "Using getServerSideProps for server-side rendering" },
        { id: 11, title: "API Routes", prompt: "Creating API endpoints with Next.js API routes" },
        { id: 12, title: "SWR for Data Fetching", prompt: "Using SWR for client-side data fetching" },
      ]
    },
    {
      category: "Styling & UI",
      items: [
        { id: 13, title: "CSS Modules", prompt: "Using CSS Modules for component styling" },
        { id: 14, title: "Styled JSX", prompt: "Implementing styled components with Styled JSX" },
        { id: 15, title: "Tailwind CSS", prompt: "Using Tailwind CSS with Next.js" },
        { id: 16, title: "UI Libraries", prompt: "Integrating UI libraries like Material UI with Next.js" },
      ]
    },
    {
      category: "Performance Optimization",
      items: [
        { id: 17, title: "Image Optimization", prompt: "Using Next.js Image component for optimized images" },
        { id: 18, title: "Code Splitting", prompt: "Implementing automatic code splitting in Next.js" },
        { id: 19, title: "Lazy Loading", prompt: "Using lazy loading for components and images" },
        { id: 20, title: "Caching Strategies", prompt: "Implementing caching for better performance" },
      ]
    },
    {
      category: "Authentication & Security",
      items: [
        { id: 21, title: "Authentication", prompt: "Implementing authentication in Next.js applications" },
        { id: 22, title: "API Security", prompt: "Securing Next.js API routes" },
        { id: 23, title: "Environment Variables", prompt: "Using environment variables in Next.js" },
        { id: 24, title: "CORS & CSRF Protection", prompt: "Implementing CORS and CSRF protection" },
      ]
    },
    {
      category: "Advanced Features",
      items: [
        { id: 25, title: "Middleware", prompt: "Using Next.js middleware for request handling" },
        { id: 26, title: "Internationalization", prompt: "Implementing i18n in Next.js applications" },
        { id: 27, title: "Analytics", prompt: "Adding analytics to Next.js applications" },
        { id: 28, title: "Custom Webpack Config", prompt: "Customizing Webpack configuration in Next.js" },
      ]
    },
    {
      category: "Deployment & CI/CD",
      items: [
        { id: 29, title: "Vercel Deployment", prompt: "Deploying Next.js applications to Vercel" },
        { id: 30, title: "Docker Deployment", prompt: "Containerizing Next.js applications" },
        { id: 31, title: "CI/CD Pipelines", prompt: "Setting up CI/CD pipelines for Next.js" },
        { id: 32, title: "Performance Monitoring", prompt: "Monitoring Next.js application performance" },
      ]
    },
    {
      category: "E-commerce & Real-world Apps",
      items: [
        { id: 33, title: "E-commerce Setup", prompt: "Building e-commerce applications with Next.js" },
        { id: 34, title: "Payment Integration", prompt: "Integrating payment gateways in Next.js" },
        { id: 35, title: "SEO Optimization", prompt: "Implementing SEO best practices in Next.js" },
      ]
    }
  ];
...
export default NextJSTutorials;  