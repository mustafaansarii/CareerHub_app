  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to React", prompt: "Explain React framework and its core concepts" },
        { id: 2, title: "JSX Syntax", prompt: "Understanding JSX syntax and its benefits" },
        { id: 3, title: "Components & Props", prompt: "Creating and using React components with props" },
        { id: 4, title: "State & Lifecycle", prompt: "Managing component state and lifecycle methods" },
      ]
    },
    {
      category: "Hooks & Functional Components",
      items: [
        { id: 5, title: "useState Hook", prompt: "Using useState for state management in functional components" },
        { id: 6, title: "useEffect Hook", prompt: "Managing side effects with useEffect" },
        { id: 7, title: "Custom Hooks", prompt: "Creating and using custom hooks" },
        { id: 8, title: "Context API", prompt: "Using React Context for global state management" },
      ]
    },
    {
      category: "State Management",
      items: [
        { id: 9, title: "Redux Basics", prompt: "Implementing Redux for state management" },
        { id: 10, title: "Redux Toolkit", prompt: "Using Redux Toolkit for simplified state management" },
        { id: 11, title: "Recoil", prompt: "Using Recoil for state management" },
        { id: 12, title: "Zustand", prompt: "Implementing Zustand for lightweight state management" },
      ]
    },
    {
      category: "Routing & Navigation",
      items: [
        { id: 13, title: "React Router", prompt: "Setting up routing with React Router" },
        { id: 14, title: "Nested Routes", prompt: "Implementing nested routes in React" },
        { id: 15, title: "Protected Routes", prompt: "Creating authentication-protected routes" },
        { id: 16, title: "Lazy Loading Routes", prompt: "Implementing code-splitting with lazy loading" },
      ]
    },
    {
      category: "Performance Optimization",
      items: [
        { id: 17, title: "Memoization", prompt: "Using React.memo and useMemo for performance optimization" },
        { id: 18, title: "Code Splitting", prompt: "Implementing code splitting with React.lazy" },
        { id: 19, title: "Virtualization", prompt: "Using windowing/virtualization for large lists" },
        { id: 20, title: "Profiling", prompt: "Using React DevTools for performance profiling" },
      ]
    },
    {
      category: "Testing",
      items: [
        { id: 21, title: "Jest Testing", prompt: "Writing unit tests with Jest" },
        { id: 22, title: "React Testing Library", prompt: "Testing React components with RTL" },
        { id: 23, title: "E2E Testing", prompt: "Implementing end-to-end tests with Cypress" },
        { id: 24, title: "Mocking", prompt: "Mocking API calls and dependencies in tests" },
      ]
    },
    {
      category: "Advanced Patterns",
      items: [
        { id: 25, title: "Higher-Order Components", prompt: "Creating and using HOCs" },
        { id: 26, title: "Render Props", prompt: "Implementing the render props pattern" },
        { id: 27, title: "Compound Components", prompt: "Building compound component patterns" },
        { id: 28, title: "Error Boundaries", prompt: "Implementing error boundaries in React" },
      ]
    },
    {
      category: "Styling & UI",
      items: [
        { id: 29, title: "CSS-in-JS", prompt: "Using styled-components and emotion" },
        { id: 30, title: "CSS Modules", prompt: "Implementing CSS Modules in React" },
        { id: 31, title: "Tailwind CSS", prompt: "Using Tailwind CSS with React" },
        { id: 32, title: "Component Libraries", prompt: "Using Material UI or Chakra UI" },
      ]
    },
    {
      category: "Server-side Rendering",
      items: [
        { id: 33, title: "Next.js Basics", prompt: "Implementing SSR with Next.js" },
        { id: 34, title: "Data Fetching", prompt: "Using getStaticProps and getServerSideProps" },
        { id: 35, title: "API Routes", prompt: "Creating API endpoints in Next.js" },
        { id: 36, title: "Static Site Generation", prompt: "Implementing SSG in Next.js" },
      ]
    },
    {
      category: "TypeScript with React",
      items: [
        { id: 37, title: "TypeScript Basics", prompt: "Setting up TypeScript with React" },
        { id: 38, title: "Type Safety", prompt: "Implementing type safety in React components" },
        { id: 39, title: "Advanced Types", prompt: "Using advanced TypeScript patterns with React" },
        { id: 40, title: "TypeScript with Hooks", prompt: "Using TypeScript with React hooks" },
      ]
    }
  ];
