  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Node.js", prompt: "Explain Node.js runtime environment and its core features" },
        { id: 2, title: "Event Loop & Async Programming", prompt: "Explain the Node.js event loop and asynchronous programming model" },
        { id: 3, title: "Core Modules", prompt: "Overview of Node.js core modules like fs, path, http, etc." },
        { id: 4, title: "NPM Basics", prompt: "Guide to using npm for package management in Node.js" },
      ]
    },
    {
      category: "File System & Streams",
      items: [
        { id: 5, title: "File Operations", prompt: "Working with files in Node.js using fs module" },
        { id: 6, title: "Streams & Buffers", prompt: "Understanding and using streams and buffers in Node.js" },
        { id: 7, title: "Error Handling", prompt: "Proper error handling techniques in Node.js applications" },
        { id: 8, title: "Path Module", prompt: "Working with file paths using the path module" },
      ]
    },
    {
      category: "Web Servers & Networking",
      items: [
        { id: 9, title: "HTTP Module", prompt: "Creating web servers using Node.js http module" },
        { id: 10, title: "REST API Basics", prompt: "Building REST APIs with Node.js" },
        { id: 11, title: "WebSockets", prompt: "Implementing real-time communication with WebSockets" },
        { id: 12, title: "TCP/UDP Servers", prompt: "Creating TCP and UDP servers in Node.js" },
      ]
    },
    {
      category: "Express.js Framework",
      items: [
        { id: 13, title: "Express Basics", prompt: "Introduction to Express.js framework" },
        { id: 14, title: "Middleware", prompt: "Understanding and creating Express middleware" },
        { id: 15, title: "Routing", prompt: "Implementing routes in Express applications" },
        { id: 16, title: "Error Handling", prompt: "Error handling in Express applications" },
      ]
    },
    {
      category: "Database Integration",
      items: [
        { id: 17, title: "MongoDB with Mongoose", prompt: "Connecting MongoDB to Node.js using Mongoose" },
        { id: 18, title: "SQL Databases", prompt: "Using SQL databases with Node.js" },
        { id: 19, title: "ORM/ODM", prompt: "Using ORMs and ODMs in Node.js applications" },
        { id: 20, title: "Database Migrations", prompt: "Managing database schema changes in Node.js" },
      ]
    },
    {
      category: "Authentication & Security",
      items: [
        { id: 21, title: "JWT Authentication", prompt: "Implementing JWT authentication in Node.js" },
        { id: 22, title: "OAuth Integration", prompt: "Adding OAuth authentication to Node.js apps" },
        { id: 23, title: "Security Best Practices", prompt: "Security best practices for Node.js applications" },
        { id: 24, title: "Password Hashing", prompt: "Implementing secure password storage in Node.js" },
      ]
    },
    {
      category: "Performance Optimization",
      items: [
        { id: 25, title: "Caching Strategies", prompt: "Implementing caching in Node.js applications" },
        { id: 26, title: "Load Balancing", prompt: "Setting up load balancing for Node.js apps" },
        { id: 27, title: "Cluster Module", prompt: "Using Node.js cluster module for performance" },
        { id: 28, title: "Profiling & Debugging", prompt: "Profiling and debugging Node.js applications" },
      ]
    },
    {
      category: "Testing & Quality",
      items: [
        { id: 29, title: "Unit Testing", prompt: "Writing unit tests for Node.js applications" },
        { id: 30, title: "Integration Testing", prompt: "Implementing integration tests in Node.js" },
        { id: 31, title: "Test Coverage", prompt: "Measuring and improving test coverage in Node.js" },
        { id: 32, title: "CI/CD Pipelines", prompt: "Setting up CI/CD pipelines for Node.js projects" },
      ]
    },
    {
      category: "Advanced Concepts",
      items: [
        { id: 33, title: "Event Emitters", prompt: "Understanding and using Event Emitters in Node.js" },
        { id: 34, title: "Worker Threads", prompt: "Using worker threads for CPU-intensive tasks" },
        { id: 35, title: "Child Processes", prompt: "Working with child processes in Node.js" },
        { id: 36, title: "Microservices", prompt: "Building microservices with Node.js" },
      ]
    },
    {
      category: "Production & Deployment",
      items: [
        { id: 37, title: "Environment Configuration", prompt: "Managing environment variables in Node.js" },
        { id: 38, title: "Docker Deployment", prompt: "Containerizing Node.js applications with Docker" },
        { id: 39, title: "PM2 Process Manager", prompt: "Using PM2 for production process management" },
        { id: 40, title: "Logging & Monitoring", prompt: "Implementing logging and monitoring in production" },
      ]
    }
  ];
