...
const SpringBootTutorials = () => {
  ...
  const topics = [
    {
      category: "Spring Boot Fundamentals",
      items: [
        { id: 1, title: "Introduction to Spring Boot", prompt: "Explain Spring Boot framework and its advantages for Java development" },
        { id: 2, title: "Project Setup", prompt: "Guide to creating a Spring Boot project using Spring Initializr" },
        { id: 3, title: "Auto Configuration", prompt: "Understanding Spring Boot's auto-configuration mechanism" },
        { id: 4, title: "Spring Boot Starters", prompt: "Using Spring Boot starters for common application needs" },
      ]
    },
    {
      category: "Web Development",
      items: [
        { id: 5, title: "REST API Development", prompt: "Creating RESTful web services with Spring Boot" },
        { id: 6, title: "Thymeleaf Templates", prompt: "Using Thymeleaf for server-side rendering in Spring Boot" },
        { id: 7, title: "Error Handling", prompt: "Implementing global exception handling in Spring Boot" },
        { id: 8, title: "Validation", prompt: "Implementing request validation with Hibernate Validator" },
      ]
    },
    {
      category: "Database Integration",
      items: [
        { id: 9, title: "Spring Data JPA", prompt: "Using Spring Data JPA for database operations" },
        { id: 10, title: "Database Migrations", prompt: "Managing database schema changes with Flyway/Liquibase" },
        { id: 11, title: "Transaction Management", prompt: "Implementing transaction management in Spring Boot" },
        { id: 12, title: "Query Optimization", prompt: "Optimizing database queries in Spring Boot applications" },
      ]
    },
    {
      category: "Security",
      items: [
        { id: 13, title: "Spring Security", prompt: "Implementing authentication and authorization with Spring Security" },
        { id: 14, title: "OAuth2 Integration", prompt: "Implementing OAuth2 authentication in Spring Boot" },
        { id: 15, title: "JWT Authentication", prompt: "Implementing JWT-based authentication in Spring Boot" },
        { id: 16, title: "Security Best Practices", prompt: "Implementing security measures in Spring Boot applications" },
      ]
    },
    {
      category: "Testing",
      items: [
        { id: 17, title: "Unit Testing", prompt: "Writing unit tests with JUnit and Mockito" },
        { id: 18, title: "Integration Testing", prompt: "Testing Spring Boot applications with Spring Boot Test" },
        { id: 19, title: "Test Containers", prompt: "Using Testcontainers for integration testing" },
        { id: 20, title: "Code Coverage", prompt: "Measuring code coverage with Jacoco" },
      ]
    },
    {
      category: "Advanced Features",
      items: [
        { id: 21, title: "Actuator", prompt: "Using Spring Boot Actuator for application monitoring" },
        { id: 22, title: "Caching", prompt: "Implementing caching in Spring Boot applications" },
        { id: 23, title: "Async Processing", prompt: "Implementing asynchronous processing in Spring Boot" },
        { id: 24, title: "Scheduling", prompt: "Implementing scheduled tasks in Spring Boot" },
      ]
    },
    {
      category: "Microservices",
      items: [
        { id: 25, title: "Spring Cloud", prompt: "Building microservices with Spring Cloud" },
        { id: 26, title: "Service Discovery", prompt: "Implementing service discovery with Eureka" },
        { id: 27, title: "API Gateway", prompt: "Implementing API Gateway with Spring Cloud Gateway" },
        { id: 28, title: "Distributed Tracing", prompt: "Implementing distributed tracing with Sleuth and Zipkin" },
      ]
    },
    {
      category: "Production & Deployment",
      items: [
        { id: 29, title: "Docker Deployment", prompt: "Containerizing Spring Boot applications with Docker" },
        { id: 30, title: "Kubernetes Deployment", prompt: "Deploying Spring Boot applications to Kubernetes" },
        { id: 31, title: "Profiles", prompt: "Using Spring profiles for environment-specific configuration" },
        { id: 32, title: "Performance Tuning", prompt: "Performance optimization techniques for Spring Boot applications" },
      ]
    },
    {
      category: "Messaging",
      items: [
        { id: 33, title: "RabbitMQ", prompt: "Implementing message queues with RabbitMQ" },
        { id: 34, title: "Kafka", prompt: "Implementing event-driven architecture with Kafka" },
        { id: 35, title: "WebSockets", prompt: "Implementing real-time features with WebSockets" },
      ]
    },
    {
      category: "Monitoring & Logging",
      items: [
        { id: 36, title: "Logging", prompt: "Configuring logging in Spring Boot applications" },
        { id: 37, title: "Metrics", prompt: "Collecting and analyzing application metrics" },
        { id: 38, title: "Alerting", prompt: "Setting up alerting for Spring Boot applications" },
      ]
    }
  ];
...
export default SpringBootTutorials;  