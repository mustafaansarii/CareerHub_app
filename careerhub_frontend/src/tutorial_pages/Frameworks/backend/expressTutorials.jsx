...
const ExpressTutorials = () => {
  ...
  const topics = [
    {
      category: "Express Fundamentals",
      items: [
        { id: 1, title: "Introduction to Express.js", prompt: "Explain Express.js framework and its core features for building web applications" },
        { id: 2, title: "Project Setup & Configuration", prompt: "Step-by-step guide to initializing an Express project with npm and basic configuration" },
        { id: 3, title: "Middleware Concepts", prompt: "Understanding Express middleware architecture and common use cases" },
        { id: 4, title: "Routing Fundamentals", prompt: "Creating basic routes and handling HTTP methods in Express" },
      ]
    },
    {
      category: "Core Components",
      items: [
        { id: 5, title: "Advanced Routing Techniques", prompt: "Implementing route parameters, query strings, and route organization" },
        { id: 6, title: "Template Engines", prompt: "Using Pug/EJS with Express for server-side rendering" },
        { id: 7, title: "Error Handling", prompt: "Implementing custom error handling middleware and HTTP error responses" },
        { id: 8, title: "Request & Response Objects", prompt: "Working with req/res objects and their properties" },
      ]
    },
    {
      category: "REST API Development",
      items: [
        { id: 9, title: "Building RESTful APIs", prompt: "Creating RESTful endpoints with proper HTTP status codes" },
        { id: 10, title: "API Authentication", prompt: "Implementing JWT authentication in Express APIs" },
        { id: 11, title: "Rate Limiting", prompt: "Adding request rate limiting and throttling to endpoints" },
        { id: 12, title: "API Documentation", prompt: "Generating API documentation with Swagger/OpenAPI" },
      ]
    },
    {
      category: "Database Integration",
      items: [
        { id: 13, title: "MongoDB with Mongoose", prompt: "Connecting Express to MongoDB using Mongoose ODM" },
        { id: 14, title: "SQL Databases", prompt: "Using Sequelize ORM with relational databases" },
        { id: 15, title: "Database Migrations", prompt: "Managing database schema changes and migrations" },
        { id: 16, title: "Query Optimization", prompt: "Performance optimization techniques for database operations" },
      ]
    },
    {
      category: "Authentication & Security",
      items: [
        { id: 17, title: "User Authentication", prompt: "Implementing local and OAuth authentication strategies" },
        { id: 18, title: "Password Hashing", prompt: "Secure password storage with bcrypt and salting" },
        { id: 19, title: "Security Best Practices", prompt: "Helmet.js configuration and security headers setup" },
        { id: 20, title: "CORS Management", prompt: "Configuring cross-origin resource sharing properly" },
      ]
    },
    {
      category: "Advanced Middleware",
      items: [
        { id: 21, title: "Custom Middleware", prompt: "Creating and organizing application-specific middleware" },
        { id: 22, title: "Request Validation", prompt: "Implementing request body validation with Joi/celebrate" },
        { id: 23, title: "Logging & Monitoring", prompt: "Setting up request logging and application monitoring" },
        { id: 24, title: "Compression & Caching", prompt: "Optimizing performance with compression and caching middleware" },
      ]
    },
    {
      category: "Production & Deployment",
      items: [
        { id: 25, title: "Environment Configuration", prompt: "Managing different environments with .env files" },
        { id: 26, title: "Docker Deployment", prompt: "Containerizing Express applications with Docker" },
        { id: 27, title: "Cluster Mode", prompt: "Implementing Node.js cluster mode for performance" },
        { id: 28, title: "PM2 Process Management", prompt: "Using PM2 for production process management" },
      ]
    },
    {
      category: "Testing & Quality",
      items: [
        { id: 29, title: "Unit Testing", prompt: "Writing unit tests with Jest/Mocha and Chai" },
        { id: 30, title: "Integration Testing", prompt: "Testing Express routes and middleware with Supertest" },
        { id: 31, title: "Code Quality", prompt: "Setting up ESLint and Prettier for code consistency" },
        { id: 32, title: "CI/CD Pipelines", prompt: "Implementing continuous integration and deployment workflows" },
      ]
    },
    {
      category: "Real-time Features",
      items: [
        { id: 33, title: "WebSockets", prompt: "Implementing real-time features with Socket.io" },
        { id: 34, title: "Server-Sent Events", prompt: "Using SSE for real-time updates from server" },
        { id: 35, title: "Webhook Handling", prompt: "Creating and managing webhook endpoints" },
      ]
    },
    {
      category: "Microservices & Scaling",
      items: [
        { id: 36, title: "Microservice Architecture", prompt: "Building microservices with Express" },
        { id: 37, title: "Message Queues", prompt: "Implementing RabbitMQ/Redis for inter-service communication" },
        { id: 38, title: "Load Balancing", prompt: "Configuring load balancing for Express applications" },
      ]
    },
    {
      category: "Third-Party Integrations",
      items: [
        { id: 39, title: "Payment Processing", prompt: "Integrating Stripe/PayPal payment gateways" },
        { id: 40, title: "Email Services", prompt: "Implementing email sending with Nodemailer" },
        { id: 41, title: "Cloud Storage", prompt: "Using AWS S3/Google Cloud Storage for file uploads" },
      ]
    },
    {
      category: "Performance Optimization",
      items: [
        { id: 42, title: "Caching Strategies", prompt: "Implementing Redis caching for improved performance" },
        { id: 43, title: "Connection Pooling", prompt: "Optimizing database connection management" },
        { id: 44, title: "Compression Techniques", prompt: "Advanced response compression methods" },
      ]
    }
  ];
...
export default ExpressTutorials;  