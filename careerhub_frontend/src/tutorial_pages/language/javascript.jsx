  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to JavaScript", prompt: "Explain JavaScript language and core concepts" },
        { id: 2, title: "Variables & Data Types", prompt: "Guide to using variables and data types in JavaScript" },
        { id: 3, title: "Operators & Expressions", prompt: "Understanding JavaScript operators and expressions" },
        { id: 4, title: "Control Structures", prompt: "Understanding JavaScript control structures" },
      ]
    },
    {
      category: "Functions & Objects",
      items: [
        { id: 5, title: "Functions", prompt: "Guide to creating and using functions in JavaScript" },
        { id: 6, title: "Objects", prompt: "Creating and using objects in JavaScript" },
        { id: 7, title: "Arrays", prompt: "Creating and using arrays in JavaScript" },
        { id: 8, title: "Date & Time", prompt: "Working with date and time in JavaScript" },
      ]
    },
    {
      category: "DOM & Events",
      items: [
        { id: 9, title: "DOM Manipulation", prompt: "Manipulating the Document Object Model (DOM) in JavaScript" },
        { id: 10, title: "Events", prompt: "Handling events in JavaScript" },
        { id: 11, title: "Event Bubbling & Capturing", prompt: "Understanding event bubbling and capturing" },
        { id: 12, title: "Event Delegation", prompt: "Using event delegation in JavaScript" },
      ]
    },
    {
      category: "Asynchronous Programming",
      items: [
        { id: 13, title: "Callbacks", prompt: "Understanding callbacks in JavaScript" },
        { id: 14, title: "Promises", prompt: "Working with promises in JavaScript" },
        { id: 15, title: "Async/Await", prompt: "Using async/await for asynchronous programming" },
        { id: 16, title: "Fetch API", prompt: "Making API calls with the Fetch API" },
      ]
    },
    {
      category: "ES6 Features",
      items: [
        { id: 17, title: "let & const", prompt: "Understanding let and const in ES6" },
        { id: 18, title: "Arrow Functions", prompt: "Using arrow functions in ES6" },
        { id: 19, title: "Template Literals", prompt: "Using template literals in ES6" },
        { id: 20, title: "Destructuring", prompt: "Using destructuring in ES6" },
      ]
    },
    {
      category: "Modules & Classes",
      items: [
        { id: 21, title: "Modules", prompt: "Understanding modules in JavaScript" },
        { id: 22, title: "Classes", prompt: "Creating and using classes in JavaScript" },
        { id: 23, title: "Inheritance", prompt: "Understanding inheritance in JavaScript" },
        { id: 24, title: "Modules in ES6", prompt: "Understanding modules in ES6" },
      ]
    },
    {
      category: "Regular Expressions",
      items: [
        { id: 25, title: "Introduction to Regular Expressions", prompt: "Understanding regular expressions in JavaScript" },
        { id: 26, title: "Creating Regular Expressions", prompt: "Creating regular expressions in JavaScript" },
        { id: 27, title: "Regular Expression Methods", prompt: "Using regular expression methods in JavaScript" },
        { id: 28, title: "Regular Expression Patterns", prompt: "Understanding regular expression patterns" },
      ]
    },
    {
      category: "Error Handling",
      items: [
        { id: 29, title: "try...catch Statement", prompt: "Using the try...catch statement for error handling" },
        { id: 30, title: "throw Statement", prompt: "Throwing exceptions in JavaScript" },
        { id: 31, title: "Custom Errors", prompt: "Creating and using custom errors in JavaScript" },
        { id: 32, title: "Error Handling Best Practices", prompt: "Best practices for error handling in JavaScript" },
      ]
    },
    {
      category: "Browser Object Model",
      items: [
        { id: 33, title: "Window Object", prompt: "Understanding the window object in JavaScript" },
        { id: 34, title: "Location Object", prompt: "Using the location object in JavaScript" },
        { id: 35, title: "Navigator Object", prompt: "Using the navigator object in JavaScript" },
        { id: 36, title: "Screen Object", prompt: "Using the screen object in JavaScript" },
      ]
    },
    {
      category: "Document Object Model",
      items: [
        { id: 37, title: "Document Object", prompt: "Understanding the document object in JavaScript" },
        { id: 38, title: "Element Object", prompt: "Using the element object in JavaScript" },
        { id: 39, title: "Node Object", prompt: "Using the node object in JavaScript" },
        { id: 40, title: "Events in the DOM", prompt: "Understanding events in the DOM" },
      ]
    }
  ];
