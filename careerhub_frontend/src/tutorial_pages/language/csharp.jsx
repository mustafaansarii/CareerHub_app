  ...
  const topics = [
    {
      category: "C# Basics",
      items: [
        { id: 1, title: "Introduction to C#", prompt: "Explain C# programming language fundamentals and features" },
        { id: 2, title: "Data Types & Variables", prompt: "Understanding C# data types and variable declaration" },
        { id: 3, title: "Operators", prompt: "Working with C# operators and expressions" },
        { id: 4, title: "Control Structures", prompt: "Using if-else, switch, and loops in C#" },
      ]
    },
    {
      category: "Object-Oriented Programming",
      items: [
        { id: 5, title: "Classes & Objects", prompt: "Understanding classes and objects in C#" },
        { id: 6, title: "Inheritance", prompt: "Implementing inheritance in C#" },
        { id: 7, title: "Polymorphism", prompt: "Understanding and implementing polymorphism in C#" },
        { id: 8, title: "Interfaces", prompt: "Working with interfaces in C#" },
      ]
    },
    {
      category: "Advanced C#",
      items: [
        { id: 9, title: "Generics", prompt: "Understanding and using generics in C#" },
        { id: 10, title: "Delegates & Events", prompt: "Working with delegates and events in C#" },
        { id: 11, title: "LINQ", prompt: "Using Language Integrated Query (LINQ) in C#" },
        { id: 12, title: "Asynchronous Programming", prompt: "Implementing async/await in C#" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 15, title: "Exception Best Practices", prompt: "Best practices for exception handling in C#" },
        { id: 16, title: "Logging Exceptions", prompt: "Implementing exception logging in C#" },
      ]
    },
    {
      category: "Collections & Data Structures",
      items: [
        { id: 17, title: "Arrays & Lists", prompt: "Working with arrays and lists in C#" },
    ...
    },
    {
      ...
      items: [
        { id: 21, title: "File Operations", prompt: "Reading and writing files in C#" },
        { id: 22, title: "JSON Serialization", prompt: "Working with JSON data in C#" },
        { id: 23, title: "XML Serialization", prompt: "Serializing and deserializing XML data" },
        { id: 24, title: "Binary Serialization", prompt: "Using binary serialization in C#" },
      ]
    },
    {
      category: "Networking",
      items: [
        { id: 25, title: "HTTP Requests", prompt: "Making HTTP requests in C#" },
        { id: 26, title: "Sockets", prompt: "Implementing socket programming in C#" },
        { id: 27, title: "Web Services", prompt: "Creating and consuming web services" },
        { id: 28, title: "REST APIs", prompt: "Building and consuming REST APIs in C#" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 31, title: "Stored Procedures", prompt: "Calling stored procedures from C#" },
    ...
    },
    {
      ...
      items: [
        { id: 33, title: "Unit Testing", prompt: "Writing unit tests in C#" },
        { id: 34, title: "Debugging Techniques", prompt: "Effective debugging strategies in C#" },
        { id: 35, title: "Test Automation", prompt: "Implementing automated testing in C#" },
        { id: 36, title: "Performance Profiling", prompt: "Analyzing and optimizing C# code performance" },
      ]
    },
    {
      category: "Advanced Topics",
      items: [
        { id: 37, title: "Reflection", prompt: "Using reflection in C#" },
        { id: 38, title: "Attributes", prompt: "Creating and using custom attributes" },
        { id: 39, title: "Dynamic Programming", prompt: "Working with dynamic types in C#" },
        { id: 40, title: "Parallel Programming", prompt: "Implementing parallel processing in C#" },
      ]
    }
  ];
          ...
          <div className="pl-4">
            {category.items.map((topic) => (
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded-lg transition-colors ${selectedTopic?.id === topic.id
        ...
        >
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            >
              ...
              <ChevronRightIcon
                className={`w-5 h-5 transition-transform ${isMobileMenuOpen
              ...
              <div className="mb-8">
                <nav className="flex" aria-label="Breadcrumb">
                  <ol className="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li className="inline-flex items-center">
                      <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                      <span className="text-indigo-600">C# Tutorials</span>
                    </li>
                  </ol>
                </nav>
...
export default CsharpTutorials;  