  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Swift", prompt: "Explain Swift programming language fundamentals and features" },
        { id: 2, title: "Data Types & Variables", prompt: "Understanding Swift data types and variable declaration" },
        { id: 3, title: "Operators", prompt: "Working with Swift operators and expressions" },
        { id: 4, title: "Control Structures", prompt: "Using if-else, switch, and loops in Swift" },
      ]
    },
    {
      category: "Object-Oriented Programming",
      items: [
        { id: 5, title: "Classes & Objects", prompt: "Understanding classes and objects in Swift" },
        { id: 6, title: "Inheritance", prompt: "Implementing inheritance in Swift" },
        { id: 7, title: "Polymorphism", prompt: "Understanding and implementing polymorphism in Swift" },
        { id: 8, title: "Interfaces", prompt: "Working with interfaces in Swift" },
      ]
    },
    {
      category: "Advanced Swift",
      items: [
        { id: 9, title: "Generics", prompt: "Understanding and using generics in Swift" },
        { id: 10, title: "Delegates & Events", prompt: "Working with delegates and events in Swift" },
        { id: 11, title: "LINQ", prompt: "Using Language Integrated Query (LINQ) in Swift" },
        { id: 12, title: "Asynchronous Programming", prompt: "Implementing async/await in Swift" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 15, title: "Exception Best Practices", prompt: "Best practices for exception handling in Swift" },
        { id: 16, title: "Logging Exceptions", prompt: "Implementing exception logging in Swift" },
      ]
    },
    {
      category: "Collections & Data Structures",
      items: [
        { id: 17, title: "Arrays & Lists", prompt: "Working with arrays and lists in Swift" },
    ...
    },
    {
      ...
      items: [
        { id: 21, title: "File Operations", prompt: "Reading and writing files in Swift" },
        { id: 22, title: "JSON Serialization", prompt: "Working with JSON data in Swift" },
        { id: 23, title: "XML Serialization", prompt: "Serializing and deserializing XML data" },
        { id: 24, title: "Binary Serialization", prompt: "Using binary serialization in Swift" },
      ]
    },
    {
      category: "Networking",
      items: [
        { id: 25, title: "HTTP Requests", prompt: "Making HTTP requests in Swift" },
        { id: 26, title: "Sockets", prompt: "Implementing socket programming in Swift" },
        { id: 27, title: "Web Services", prompt: "Creating and consuming web services" },
        { id: 28, title: "REST APIs", prompt: "Building and consuming REST APIs in Swift" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 31, title: "Stored Procedures", prompt: "Calling stored procedures from Swift" },
    ...
    },
    {
      ...
      items: [
        { id: 33, title: "Unit Testing", prompt: "Writing unit tests in Swift" },
        { id: 34, title: "Debugging Techniques", prompt: "Effective debugging strategies in Swift" },
        { id: 35, title: "Test Automation", prompt: "Implementing automated testing in Swift" },
        { id: 36, title: "Performance Profiling", prompt: "Analyzing and optimizing Swift code performance" },
      ]
    },
    {
      category: "Advanced Topics",
      items: [
        { id: 37, title: "Reflection", prompt: "Using reflection in Swift" },
        { id: 38, title: "Attributes", prompt: "Creating and using custom attributes" },
        { id: 39, title: "Dynamic Programming", prompt: "Working with dynamic types in Swift" },
        { id: 40, title: "Parallel Programming", prompt: "Implementing parallel processing in Swift" },
      ]
    }
  ];
