  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Ruby", prompt: "Explain Ruby programming language fundamentals and features" },
        { id: 2, title: "Data Types & Variables", prompt: "Understanding Ruby data types and variable declaration" },
        { id: 3, title: "Operators", prompt: "Working with Ruby operators and expressions" },
        { id: 4, title: "Control Structures", prompt: "Using if-else, switch, and loops in Ruby" },
      ]
    },
    {
      category: "Object-Oriented Programming",
      items: [
        { id: 5, title: "Classes & Objects", prompt: "Understanding classes and objects in Ruby" },
        { id: 6, title: "Inheritance", prompt: "Implementing inheritance in Ruby" },
        { id: 7, title: "Polymorphism", prompt: "Understanding and implementing polymorphism in Ruby" },
        { id: 8, title: "Interfaces", prompt: "Working with interfaces in Ruby" },
      ]
    },
    {
      category: "Advanced Ruby",
      items: [
        { id: 9, title: "Generics", prompt: "Understanding and using generics in Ruby" },
        { id: 10, title: "Delegates & Events", prompt: "Working with delegates and events in Ruby" },
        { id: 11, title: "LINQ", prompt: "Using Language Integrated Query (LINQ) in Ruby" },
        { id: 12, title: "Asynchronous Programming", prompt: "Implementing async/await in Ruby" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 15, title: "Exception Best Practices", prompt: "Best practices for exception handling in Ruby" },
        { id: 16, title: "Logging Exceptions", prompt: "Implementing exception logging in Ruby" },
      ]
    },
    {
      category: "Collections & Data Structures",
      items: [
        { id: 17, title: "Arrays & Lists", prompt: "Working with arrays and lists in Ruby" },
    ...
    },
    {
      ...
      items: [
        { id: 21, title: "File Operations", prompt: "Reading and writing files in Ruby" },
        { id: 22, title: "JSON Serialization", prompt: "Working with JSON data in Ruby" },
        { id: 23, title: "XML Serialization", prompt: "Serializing and deserializing XML data" },
        { id: 24, title: "Binary Serialization", prompt: "Using binary serialization in Ruby" },
      ]
    },
    {
      category: "Networking",
      items: [
        { id: 25, title: "HTTP Requests", prompt: "Making HTTP requests in Ruby" },
        { id: 26, title: "Sockets", prompt: "Implementing socket programming in Ruby" },
        { id: 27, title: "Web Services", prompt: "Creating and consuming web services" },
        { id: 28, title: "REST APIs", prompt: "Building and consuming REST APIs in Ruby" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 31, title: "Stored Procedures", prompt: "Calling stored procedures from Ruby" },
    ...
    },
    {
      ...
      items: [
        { id: 33, title: "Unit Testing", prompt: "Writing unit tests in Ruby" },
        { id: 34, title: "Debugging Techniques", prompt: "Effective debugging strategies in Ruby" },
        { id: 35, title: "Test Automation", prompt: "Implementing automated testing in Ruby" },
        { id: 36, title: "Performance Profiling", prompt: "Analyzing and optimizing Ruby code performance" },
      ]
    },
    {
      category: "Advanced Topics",
      items: [
        { id: 37, title: "Reflection", prompt: "Using reflection in Ruby" },
        { id: 38, title: "Attributes", prompt: "Creating and using custom attributes" },
        { id: 39, title: "Dynamic Programming", prompt: "Working with dynamic types in Ruby" },
        { id: 40, title: "Parallel Programming", prompt: "Implementing parallel processing in Ruby" },
      ]
    }
  ];
              ...
              <div className="mb-8">
                <nav className="flex" aria-label="Breadcrumb">
                  <ol className="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li className="inline-flex items-center">
                      <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                      <span className="text-indigo-600">Ruby Tutorials</span>
                    </li>
                  </ol>
                </nav>
