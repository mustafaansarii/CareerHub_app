  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Python", prompt: "Explain Python's features and use cases" },
        { id: 2, title: "Python Syntax", prompt: "Guide to basic Python syntax and program structure" },
        { id: 3, title: "Data Types", prompt: "Understanding Python's data types and type conversion" },
        { id: 4, title: "Control Flow", prompt: "Working with loops and conditional statements in Python" },
      ]
    },
    {
      category: "OOP Concepts",
      items: [
        { id: 5, title: "Classes & Objects", prompt: "Creating and using classes/objects in Python" },
        { id: 6, title: "Inheritance", prompt: "Implementing inheritance and method overriding" },
        { id: 7, title: "Polymorphism", prompt: "Understanding compile-time and runtime polymorphism" },
        { id: 8, title: "Encapsulation", prompt: "Implementing data hiding with access modifiers" },
      ]
    },
    {
      category: "Python Collections",
      items: [
        { id: 9, title: "List Interface", prompt: "Working with Python lists" },
        { id: 10, title: "Dictionary Interface", prompt: "Using Python dictionaries" },
        { id: 11, title: "Set Interface", prompt: "Understanding Python sets" },
        { id: 12, title: "Generator Expressions", prompt: "Using generator expressions" },
      ]
    },
    {
      category: "Exception Handling",
      items: [
        { id: 13, title: "Try-Except", prompt: "Implementing exception handling blocks" },
        { id: 14, title: "Custom Exceptions", prompt: "Creating user-defined exception classes" },
        { id: 15, title: "Exception Types", prompt: "Difference between checked and unchecked exceptions" },
        { id: 16, title: "Best Practices", prompt: "Exception handling patterns and anti-patterns" },
      ]
    },
    {
      category: "I/O Operations",
      items: [
        { id: 17, title: "File Handling", prompt: "Reading/writing files with Python I/O" },
        { id: 18, title: "NIO Package", prompt: "Using buffers and channels for I/O" },
        { id: 19, title: "Serialization", prompt: "Object serialization/deserialization" },
        { id: 20, title: "Python Networking", prompt: "Socket programming basics" },
      ]
    },
    {
      category: "Concurrency",
      items: [
        { id: 21, title: "Thread Basics", prompt: "Creating and managing threads" },
        { id: 22, title: "Executor Framework", prompt: "Using thread pools and executors" },
        { id: 23, title: "Synchronization", prompt: "Managing shared resources with locks" },
        { id: 24, title: "Concurrent Collections", prompt: "Using thread-safe collection classes" },
      ]
    },
    {
      category: "JDBC & Databases",
      items: [
        { id: 25, title: "JDBC Basics", prompt: "Connecting to databases with Python" },
        { id: 26, title: "CRUD Operations", prompt: "Implementing Create-Read-Update-Delete" },
        { id: 27, title: "Connection Pooling", prompt: "Using connection pools like HikariCP" },
        { id: 28, title: "Transactions", prompt: "Managing database transactions" },
      ]
    },
    {
      category: "JVM Internals",
      items: [
        { id: 29, title: "Memory Model", prompt: "Understanding heap and stack memory" },
        { id: 30, title: "Garbage Collection", prompt: "GC algorithms and performance tuning" },
        { id: 31, title: "JIT Compilation", prompt: "How Just-In-Time compiler works" },
        { id: 32, title: "Performance Tuning", prompt: "JVM optimization techniques" },
      ]
    },
    {
      category: "Frameworks",
      items: [
        { id: 33, title: "Spring Basics", prompt: "Introduction to Spring Framework" },
        { id: 34, title: "Hibernate", prompt: "ORM with Hibernate framework" },
        { id: 35, title: "Spring Boot", prompt: "Creating REST APIs with Spring Boot" },
        { id: 36, title: "Testing Frameworks", prompt: "JUnit and Mockito basics" },
      ]
    },
    {
      category: "Advanced Topics",
      items: [
        { id: 37, title: "Lambda Expressions", prompt: "Python functional programming" },
        { id: 38, title: "Modules System", prompt: "Python Platform Module System (PMS)" },
        { id: 39, title: "Security", prompt: "Python security manager and policies" },
        { id: 40, title: "Best Practices", prompt: "Python coding conventions and patterns" },
      ]
    }
  ];
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen mt-15 md:mt-15 bg-white">
        ...
        >
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            >
              ...
              <ChevronRightIcon 
                className={`w-5 h-5 transition-transform ${isMobileMenuOpen ? 'rotate-90 text-indigo-600' : 'text-gray-500'}`} 
              />
            </button>
          </div>
        </motion.div>
            ...
            >
              <div className="p-4 pt-5 border-b border-gray-200 bg-gradient-to-r from-indigo-50/70 to-blue-50/70">
                <div className="flex justify-between items-center w-full">
                  <h2 className="text-xl font-bold text-gray-900">Python Topics</h2>
                  <button
                    onClick={() => setIsMobileMenuOpen(false)}
        ...
        <div className="flex flex-col md:flex-row">
          ...
          >
            <h2 className="text-xl font-bold mb-4 text-gray-900">Python Tutorials</h2>
              ...
              <div className="mb-8">
                <nav className="flex" aria-label="Breadcrumb">
                  <ol className="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li className="inline-flex items-center">
                      <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                      <span className="text-indigo-600">Python Tutorials</span>
                    </li>
                  </ol>
                </nav>
