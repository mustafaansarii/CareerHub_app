  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Java", prompt: "Explain Java programming language fundamentals and features" },
        { id: 2, title: "Data Types & Variables", prompt: "Understanding Java data types and variable declaration" },
        { id: 3, title: "Operators", prompt: "Working with Java operators and expressions" },
        { id: 4, title: "Control Structures", prompt: "Using if-else, switch, and loops in Java" },
      ]
    },
    {
      category: "Object-Oriented Programming",
      items: [
        { id: 5, title: "Classes & Objects", prompt: "Understanding classes and objects in Java" },
        { id: 6, title: "Inheritance", prompt: "Implementing inheritance in Java" },
        { id: 7, title: "Polymorphism", prompt: "Understanding and implementing polymorphism in Java" },
        { id: 8, title: "Interfaces", prompt: "Working with interfaces in Java" },
      ]
    },
    {
      category: "Advanced Java",
      items: [
        { id: 9, title: "Generics", prompt: "Understanding and using generics in Java" },
        { id: 10, title: "Lambda Expressions", prompt: "Using lambda expressions in Java" },
        { id: 11, title: "Streams", prompt: "Working with streams in Java" },
        { id: 12, title: "Optional", prompt: "Understanding and using Optional in Java" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 15, title: "Exception Best Practices", prompt: "Best practices for exception handling in Java" },
        { id: 16, title: "Logging Exceptions", prompt: "Implementing exception logging in Java" },
      ]
    },
    {
      category: "Collections & Data Structures",
      items: [
        { id: 17, title: "Arrays & Lists", prompt: "Working with arrays and lists in Java" },
        { id: 18, title: "Maps", prompt: "Using maps for key-value pairs" },
        { id: 19, title: "Sets", prompt: "Working with sets in Java" },
        { id: 20, title: "Queues & Stacks", prompt: "Implementing queue and stack data structures" },
      ]
    },
    {
      category: "File I/O & Serialization",
      items: [
        { id: 21, title: "File Operations", prompt: "Reading and writing files in Java" },
        { id: 22, title: "JSON Serialization", prompt: "Working with JSON data in Java" },
        { id: 23, title: "XML Serialization", prompt: "Serializing and deserializing XML data" },
        { id: 24, title: "Binary Serialization", prompt: "Using binary serialization in Java" },
      ]
    },
    {
      category: "Networking",
      items: [
        { id: 25, title: "HTTP Requests", prompt: "Making HTTP requests in Java" },
        { id: 26, title: "Sockets", prompt: "Implementing socket programming in Java" },
        { id: 27, title: "Web Services", prompt: "Creating and consuming web services" },
        { id: 28, title: "REST APIs", prompt: "Building and consuming REST APIs in Java" },
      ]
    },
    {
      category: "Database Access",
      items: [
        { id: 29, title: "JDBC", prompt: "Working with JDBC for database access" },
        { id: 30, title: "JPA", prompt: "Using JPA for ORM" },
        { id: 31, title: "Hibernate", prompt: "Using Hibernate for ORM" },
    ...
    },
    {
      ...
      items: [
        { id: 33, title: "Unit Testing", prompt: "Writing unit tests in Java" },
        { id: 34, title: "Debugging Techniques", prompt: "Effective debugging strategies in Java" },
        { id: 35, title: "Test Automation", prompt: "Implementing automated testing in Java" },
        { id: 36, title: "Performance Profiling", prompt: "Analyzing and optimizing Java code performance" },
      ]
    },
    {
      category: "Advanced Topics",
      items: [
        { id: 37, title: "Reflection", prompt: "Using reflection in Java" },
        { id: 38, title: "Annotations", prompt: "Creating and using custom annotations" },
        { id: 39, title: "Concurrency", prompt: "Implementing multithreading in Java" },
        { id: 40, title: "Parallel Streams", prompt: "Working with parallel streams in Java" },
      ]
    }
  ];
