  ...
  const topics = [
    {
      ...
      items: [
        { id: 1, title: "Introduction to Typescript", prompt: "Explain Typescript programming language fundamentals and features" },
        { id: 2, title: "Data Types & Variables", prompt: "Understanding Typescript data types and variable declaration" },
        { id: 3, title: "Operators", prompt: "Working with Typescript operators and expressions" },
        { id: 4, title: "Control Structures", prompt: "Using if-else, switch, and loops in Typescript" },
      ]
    },
    {
      category: "Object-Oriented Programming",
      items: [
        { id: 5, title: "Classes & Objects", prompt: "Understanding classes and objects in Typescript" },
        { id: 6, title: "Inheritance", prompt: "Implementing inheritance in Typescript" },
        { id: 7, title: "Polymorphism", prompt: "Understanding and implementing polymorphism in Typescript" },
        { id: 8, title: "Interfaces", prompt: "Working with interfaces in Typescript" },
      ]
    },
    {
      category: "Advanced Typescript",
      items: [
        { id: 9, title: "Generics", prompt: "Understanding and using generics in Typescript" },
        { id: 10, title: "Delegates & Events", prompt: "Working with delegates and events in Typescript" },
        { id: 11, title: "LINQ", prompt: "Using Language Integrated Query (LINQ) in Typescript" },
        { id: 12, title: "Asynchronous Programming", prompt: "Implementing async/await in Typescript" },
      ]
    },
    {
      category: "Exception Handling",
      items: [
        { id: 13, title: "Try-Catch Blocks", prompt: "Handling exceptions with try-catch blocks" },
        { id: 14, title: "Custom Exceptions", prompt: "Creating and using custom exceptions" },
        { id: 15, title: "Exception Best Practices", prompt: "Best practices for exception handling in Typescript" },
        { id: 16, title: "Logging Exceptions", prompt: "Implementing exception logging in Typescript" },
      ]
    },
    {
      category: "Collections & Data Structures",
      items: [
        { id: 17, title: "Arrays & Lists", prompt: "Working with arrays and lists in Typescript" },
        { id: 18, title: "Dictionaries", prompt: "Using dictionaries for key-value pairs" },
        { id: 19, title: "Stacks & Queues", prompt: "Implementing stack and queue data structures" },
        { id: 20, title: "Custom Collections", prompt: "Creating custom collection classes" },
      ]
    },
    {
      category: "File I/O & Serialization",
      items: [
        { id: 21, title: "File Operations", prompt: "Reading and writing files in Typescript" },
        { id: 22, title: "JSON Serialization", prompt: "Working with JSON data in Typescript" },
        { id: 23, title: "XML Serialization", prompt: "Serializing and deserializing XML data" },
        { id: 24, title: "Binary Serialization", prompt: "Using binary serialization in Typescript" },
      ]
    },
    {
      category: "Networking",
      items: [
        { id: 25, title: "HTTP Requests", prompt: "Making HTTP requests in Typescript" },
        { id: 26, title: "Sockets", prompt: "Implementing socket programming in Typescript" },
        { id: 27, title: "Web Services", prompt: "Creating and consuming web services" },
        { id: 28, title: "REST APIs", prompt: "Building and consuming REST APIs in Typescript" },
      ]
    },
    {
      category: "Database Access",
      items: [
        { id: 29, title: "ADO.NET Basics", prompt: "Working with ADO.NET for database access" },
        { id: 30, title: "Entity Framework", prompt: "Using Entity Framework for ORM" },
        { id: 31, title: "Stored Procedures", prompt: "Calling stored procedures from Typescript" },
        { id: 32, title: "Database Transactions", prompt: "Implementing database transactions" },
      ]
    },
    {
      category: "Testing & Debugging",
      items: [
        { id: 33, title: "Unit Testing", prompt: "Writing unit tests in Typescript" },
        { id: 34, title: "Debugging Techniques", prompt: "Effective debugging strategies in Typescript" },
        { id: 35, title: "Test Automation", prompt: "Implementing automated testing in Typescript" },
        { id: 36, title: "Performance Profiling", prompt: "Analyzing and optimizing Typescript code performance" },
      ]
    },
    {
      category: "Advanced Topics",
      items: [
        { id: 37, title: "Reflection", prompt: "Using reflection in Typescript" },
        { id: 38, title: "Attributes", prompt: "Creating and using custom attributes" },
        { id: 39, title: "Dynamic Programming", prompt: "Working with dynamic types in Typescript" },
        { id: 40, title: "Parallel Programming", prompt: "Implementing parallel processing in Typescript" },
      ]
    }
  ];
              ...
              <div className="mb-8">
                <nav className="flex" aria-label="Breadcrumb">
                  <ol className="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li className="inline-flex items-center">
                      <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                      <Link to="/tutorials/typescript" className="text-gray-500 hover:text-gray-700">TypeScript Tutorials</Link>
                    </li>
                    {selectedTopic && (
                      <li className="inline-flex items-center">
                        <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
...
export default TypescriptTutorials;  