...
const CppTutorials = () => {
  ...
  const topics = [
    ...
    },
    {
      ...
      items: [
        { id: 5, title: "Functions", prompt: "Creating and using functions in C++" },
        { id: 6, title: "Classes & Objects", prompt: "Understanding classes and objects in C++" },
        { id: 7, title: "Inheritance", prompt: "Implementing inheritance in C++" },
        { id: 8, title: "Polymorphism", prompt: "Understanding and implementing polymorphism in C++" },
      ]
    },
    {
      category: "Memory Management",
      items: [
        { id: 9, title: "Pointers", prompt: "Working with pointers in C++" },
        { id: 10, title: "Dynamic Memory", prompt: "Understanding dynamic memory allocation in C++" },
        { id: 11, title: "Smart Pointers", prompt: "Using smart pointers in modern C++" },
        { id: 12, title: "Memory Leaks", prompt: "Identifying and preventing memory leaks in C++" },
      ]
    },
    {
      category: "STL & Templates",
      items: [
        { id: 13, title: "STL Containers", prompt: "Using Standard Template Library containers in C++" },
        { id: 14, title: "STL Algorithms", prompt: "Working with STL algorithms in C++" },
        { id: 15, title: "Function Templates", prompt: "Creating and using function templates in C++" },
        { id: 16, title: "Class Templates", prompt: "Implementing class templates in C++" },
      ]
    },
    {
      category: "Advanced C++",
      items: [
        { id: 17, title: "Move Semantics", prompt: "Understanding move semantics and rvalue references" },
        { id: 18, title: "Lambda Expressions", prompt: "Using lambda expressions in C++" },
        { id: 19, title: "Concurrency", prompt: "Implementing multithreading in C++" },
        { id: 20, title: "Exception Handling", prompt: "Using try-catch blocks for error handling in C++" },
      ]
    },
    {
      category: "C++ Best Practices",
      items: [
        { id: 21, title: "Code Organization", prompt: "Best practices for organizing C++ projects" },
        { id: 22, title: "Performance Optimization", prompt: "Techniques for optimizing C++ code" },
        { id: 23, title: "Modern C++ Features", prompt: "Using modern C++ features (C++11/14/17/20)" },
        { id: 24, title: "Debugging Techniques", prompt: "Effective debugging strategies in C++" },
      ]
    },
    {
      category: "C++ Applications",
      items: [
        { id: 25, title: "Game Development", prompt: "Using C++ for game development" },
        { id: 26, title: "System Programming", prompt: "Writing system-level programs in C++" },
        { id: 27, title: "GUI Applications", prompt: "Creating GUI applications with C++" },
        { id: 28, title: "Embedded Systems", prompt: "Using C++ in embedded systems programming" },
      ]
    }
  ];
              ...
              <div className="mb-8">
                <nav className="flex" aria-label="Breadcrumb">
                  <ol className="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li className="inline-flex items-center">
                      <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                      <span className="text-gray-700">C++ Tutorials</span>
                    </li>
                  </ol>
                </nav>
              </div>
