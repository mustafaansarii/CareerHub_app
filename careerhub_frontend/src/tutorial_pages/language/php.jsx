  ...
  const topics = [
    {
      category: "PHP Basics",
      items: [
        { id: 1, title: "Introduction to PHP", prompt: "Explain PHP programming language fundamentals and features" },
        { id: 2, title: "Data Types & Variables", prompt: "Understanding PHP data types and variable declaration" },
        { id: 3, title: "Operators", prompt: "Working with PHP operators and expressions" },
        { id: 4, title: "Control Structures", prompt: "Using if-else, switch, and loops in PHP" },
      ]
    },
    {
      category: "Object-Oriented Programming",
      items: [
        { id: 5, title: "Classes & Objects", prompt: "Understanding classes and objects in PHP" },
        { id: 6, title: "Inheritance", prompt: "Implementing inheritance in PHP" },
        { id: 7, title: "Polymorphism", prompt: "Understanding and implementing polymorphism in PHP" },
        { id: 8, title: "Interfaces", prompt: "Working with interfaces in PHP" },
      ]
    },
    {
      category: "Advanced PHP",
      items: [
        { id: 9, title: "Generics", prompt: "Understanding and using generics in PHP" },
        { id: 10, title: "Delegates & Events", prompt: "Working with delegates and events in PHP" },
        { id: 11, title: "LINQ", prompt: "Using Language Integrated Query (LINQ) in PHP" },
        { id: 12, title: "Asynchronous Programming", prompt: "Implementing async/await in PHP" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 15, title: "Exception Best Practices", prompt: "Best practices for exception handling in PHP" },
        { id: 16, title: "Logging Exceptions", prompt: "Implementing exception logging in PHP" },
      ]
    },
    {
      category: "Collections & Data Structures",
      items: [
        { id: 17, title: "Arrays & Lists", prompt: "Working with arrays and lists in PHP" },
    ...
    },
    {
      ...
      items: [
        { id: 21, title: "File Operations", prompt: "Reading and writing files in PHP" },
        { id: 22, title: "JSON Serialization", prompt: "Working with JSON data in PHP" },
        { id: 23, title: "XML Serialization", prompt: "Serializing and deserializing XML data" },
        { id: 24, title: "Binary Serialization", prompt: "Using binary serialization in PHP" },
      ]
    },
    {
      category: "Networking",
      items: [
        { id: 25, title: "HTTP Requests", prompt: "Making HTTP requests in PHP" },
        { id: 26, title: "Sockets", prompt: "Implementing socket programming in PHP" },
        { id: 27, title: "Web Services", prompt: "Creating and consuming web services" },
        { id: 28, title: "REST APIs", prompt: "Building and consuming REST APIs in PHP" },
      ]
    },
    {
      ...
      items: [
        ...
        { id: 31, title: "Stored Procedures", prompt: "Calling stored procedures from PHP" },
    ...
    },
    {
      ...
      items: [
        { id: 33, title: "Unit Testing", prompt: "Writing unit tests in PHP" },
        { id: 34, title: "Debugging Techniques", prompt: "Effective debugging strategies in PHP" },
        { id: 35, title: "Test Automation", prompt: "Implementing automated testing in PHP" },
        { id: 36, title: "Performance Profiling", prompt: "Analyzing and optimizing PHP code performance" },
      ]
    },
    {
      category: "Advanced Topics",
      items: [
        { id: 37, title: "Reflection", prompt: "Using reflection in PHP" },
        { id: 38, title: "Attributes", prompt: "Creating and using custom attributes" },
        { id: 39, title: "Dynamic Programming", prompt: "Working with dynamic types in PHP" },
        { id: 40, title: "Parallel Programming", prompt: "Implementing parallel processing in PHP" },
      ]
    }
  ];
              ...
              <div className="mb-8">
                <nav className="flex" aria-label="Breadcrumb">
                  <ol className="inline-flex items-center space-x-1 text-sm">
                    ...
                    <li className="inline-flex items-center">
                      <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                      <span className="text-indigo-600">PHP Tutorials</span>
                    </li>
                  </ol>
                </nav>
